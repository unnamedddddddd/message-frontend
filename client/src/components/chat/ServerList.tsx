...
const ServerList = () => {
  ...
  return (
    <div className="flex flex-col w-20 rounded-2xl h-full bg-[#1e1f22] gap-2 items-center py-4 overflow-y-auto px-1">
      ...
      <div className="w-full h-[4px] rounded-2xl bg-[#6d7275]/40" />
