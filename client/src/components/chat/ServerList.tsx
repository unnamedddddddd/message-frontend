...
const ServerList = () => {
  ...
  return (
    <div className="flex flex-col w-20 rounded-2xl h-full bg-[#1e1f22] items-center py-4 gap-3 overflow-y-auto px-1">
      <Link to='/personalMessages' className="group w-fit p-2 rounded-2xl duration-200 
        ...
        <div className="w-full h-[4px] rounded-2xl bg-[#6d7275]/40 my-2" />
        {servers.map((server) => (
        ...
        <div className="flex justify-center mt-auto">
          <div className="flex flex-col gap-3">
            <button 
              className="text-[#a3a2a3] px-4 py-2 rounded-xl transition-colors hover:bg-[#616366]/70 font-semibold text-lg"
